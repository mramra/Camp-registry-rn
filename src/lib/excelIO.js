...
export async function exportCampTemplateReport(info, dataRows, fileName) {
  ...
  const aoa = [
    ...
    [
      '', 'اسم رب الأسرة رباعي', 'رقم الهوية', 'رقم التواصل', 'اسم زوج/ه رباعي', 'رقم هوية زوج/ه',
  ...
  // الصف الخامس (رؤوس الأعمدة التفصيلية) أطول من باقي الصفوف عشان النص
  // الطويل (مثل "مصدر دخل رب الأسرة (قطاع خاص/قطاع حكومي/لا يعمل)") يظهر
  // كاملاً بدون قص، مع wrapText المفعّل أصلاً على colHeaderStyle
  ws['!rows'] = [
    { hpt: 24 }, // صف 1: العنوان
    { hpt: 20 }, { hpt: 20 }, // صفوف 2-3: بانر المعلومات
    { hpt: 30 }, // صف 4: رؤوس الفئات
    { hpt: 48 }, // صف 5: رؤوس الأعمدة التفصيلية -- الأطول لاستيعاب النص الكامل
  ];
