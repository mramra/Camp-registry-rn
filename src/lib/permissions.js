...
const DEFAULT_ROLE_ACCESS = {
  ...
  super_admin: {
    ...
    women: true, children: true, health_records: true, health_report: true, education_status: true,
  ...
  assistant: {
    ...
    women: false, children: false, health_records: false, health_report: false, education_status: false,
